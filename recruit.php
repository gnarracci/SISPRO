...
<head>
	<meta charset="utf-8"/>
	<title>Sistema de Reclutamiento y Selección de Personal de TCV</title>
		...
		<div id="content">
			...
			<ul class="accordion" id="accordion">
				...
				<li class="bg1">
					...
					<div class="heading">Perfiles de Evaluación</div>
					<div class="bgDescription"></div>
					<div class="description">

						<h2>Perfiles</h2>
						<p>Perfiles de Evaluación para los Solicitantes</p>
					<a href="profile.php">más...</a>
				...
				<li class="bg2">
					...
					<div class="heading">Cargar Encuesta Web</div>
					<div class="bgDescription"></div>
					<div class="description">

						<h2>Encuesta Web</h2>
						<p>Carga de Perfiles a la Encuesta Web</p>
					<a href="loadsurvey.php">más...</a>
				...
				<li class="bg3">
					...
					<div class="heading">Reportes de Solicitantes</div>
					<div class="bgDescription"></div>
					<div class="description">

						<h2>Puntos del Test</h2>
						<p>Listado de Puntuaciones Obtenidas</p>
					<a href="solicitantesptos.php">más...</a>
				...
				<li class="bg4">
					...
					<div class="heading">Solicitantes según Perfil</div>
					<div class="bgDescription"></div>
					<div class="description">

						<h2>Consultas Generales de Perfiles</h2>
						<p>Evaluacion de los candidatos según parámetros</p>
					<a href="recruitlist.php">más...</a>
