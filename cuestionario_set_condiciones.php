...
include("include/mainFunctionCon.inc.php");
...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<meta charset="utf-8"/>
			<title>Configuración de Preguntas de Condición</title>
			<link rel="shortcut icon" href="favicon.ico"/>
            <link rel="stylesheet" href="cuestionario_set_condiciones.css"/>
			...
			<script src="js/modalwindows/mainFormCondicion.js"></script>
		...
		<body>
			...
			<a href="loadsurvey.php"><img src="imagenes/regresar-cues-2.png" height="68px" width="175px" id="float" title="Regresar"/></a>
			...
			<span id="rapport">Preguntas de Condiciones</span>

			<div id="is-3"></div>

			<div id="is-4"></div>

			<!-- Formulario de Carga de Preguntas de Condiciones-->

			<div class="hide" id="agregarPerfil" title="Agregar Pregunta de Condición">
				...
				<form action="" method="post" id="formProfesional" name="formProfesional">
					...
					<fieldset id="ocultos">
						...
						<input type="hidden" id="id_condicion" name="id_condicion" class="{required:true}" />
					...
					<fieldset id="datosProfesionales">
					    ...
					    <p>Pregunta de Condición</p>
					    <span></span>
					    <input type="text" tabindex="2" id="pregunta_condicion" name="pregunta_condicion" placeholder="Ingrese Pregunta" class="{required:true} span3"/>

					    <p>Tipo Respuesta</p>
					    <span></span>
					    <select tabindex="3" id="respuesta_condicion" name="respuesta_condicion" class="{required:true} span3">
					    ...
					    <fieldset id="botonera" style="text-align:center;">
					    	...
					    	<input type="submit" id="agregar" class="btn btn" value="Agregar Pregunta"/>
			...
			<a href="respuestas_condicion.php"><button id="answers" class="a_demo_one" type="submit">Configurar Respuestas</button></a>
