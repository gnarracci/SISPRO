...
<link rel="stylesheet" type="text/css" media="screen" href="reporteparafisobr.css"/>
...
<body>
	...
	<div id="contenedor">
		...
		<div id="banner">
			...
			<a href="paraobreros.php"><img src="imagenes/back1.png" width="252px" height="72px" class="regresar" alt="Regresar" title="Regresar a la página Anterior" /></a>
			...
			<a href="paraobrfijsum.php"><img src="imagenes/sumarizado.png" width="252px" height="72px" alt="sumarizado" title="Reporte Sumarizado" class="sumarizado" /></a>
		...
		<div id="cuerpo">
			...
			<span id="paraobrero">PROVISION PARAFISCAL MES <?Php echo mes()." ".date("Y");?> OBREROS TCV</span>
			
				<form id="parafisobrero" name="form1" method="post" action="">
				
					<table id="excelexport" width="900" border="0">
						  ...
						  <tr class="cabtab">
							...
							<td width="130" bgcolor="#3535e1">Departamento</td>
						  </tr>
