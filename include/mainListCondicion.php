...
//Funcion para extraer el listado de Preguntas
    function consultaPreguntas($linkDB){
        ...
        $consulta = $linkDB -> query("SELECT id_condicion,puesto_trabajo,pregunta_condicion,respuesta_condicion,pregunta_pctaje FROM cuestionario_condicion ORDER BY id_condicion ASC"); 
        ...
        if($consulta -> num_rows != 0){
            ...
            while($listadoOK = $consulta -> fetch_assoc())
            {
                $salida .= '
                    <tr>
                        <td style="color: red;font-weight: bold;text-align:center;">'.$listadoOK['id_condicion'].'</td>
