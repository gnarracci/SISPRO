...
include('include/mainListCondicion.php');
...
include('include/mainFuncRespCond.inc.php');
...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<meta charset="utf-8"/>
			<title>Configuración de Respuestas de Condición</title>
			<link rel="shortcut icon" href="favicon.ico"/>
            <link rel="stylesheet" href="respuestas_condicion.css"/>
			...
			<script src="js/modalwindows/main-view-condicion.js"></script>
		...
		<body>			
			...
			<header>
				...
				<a href="cuestionario_set_condiciones.php"><img src="imagenes/returncondicion.png" width="129px" height="43px" id="float" alt="regresar" title="Regresar"/></a>
			...
			<span id="marq">Carga de Respuestas de Condición</span>

			<!-- Ventana para visualizar las Preguntas -->

			<div id="lista-anim" title="Preguntas de Condición cargadas en el Sistema">

				<table id="listarapport" class="table table-striped table-bordered table-hover table-condensed">
					<thead>
						<tr>
							<th>Id</th>
							<th>Pregunta de Condición</th>
			...
			<span id="questions">Respuestas de Condición</span>

			<div id="is-3"></div>

			<div id="agregarRespuesta" class="hide" title="Agregar Respuesta de Condición">
				...
				<form action="" method="post" id="formResp" name="formResp">
					...
					<fieldset id="ocultos">
						...
						<input type="hidden" id="id_resp_condicion" name="id_resp_condicion" class="{required:true}" />

					</fieldset>

					<fieldset id="respuesta" style="text-align:center;">

						<p>Respuesta Pregunta de Condición</p>
						<span></span>
						<input type="text" tabindex="1" id="resp_condicion" name="resp_condicion" placeholder="Ingrese Respuesta" class="{required:true} span3"/>

						<p>Id. Pregunta de Condición a asociar</p>
						<span></span>
					...
					<fieldset id="botonera" style="text-align:center;">
						...
						<input type="submit" id="agregar" class="btn btn" value="Ingrese Respuesta"/>
