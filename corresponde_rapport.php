...
include("conexionsspi.php");
    ...
    $sql = "INSERT INTO corresponde_rapport (sipi,id_rapport,id_resp_rapport) VALUES ('$sipi_1','$sipi_2','$sipi_3')";
...
<!DOCTYPE html>
	<html lang="es">
		<head>
			...
			<link rel="stylesheet" href="corresponde_rapport.css"/>
                ...
                $(function(){
                    $("#dialog").dialog({
                        ...
                        buttons: [
                        {
                            text: "Ok",
                            click: function(){
                                $(location).attr('href','correspondencia_rapport.php');
                            }
                        },
                        {
                            text: "Cancelar",
		...
		<body>
            ...
            <a href="correspondencia_rapport.php"><button id="regresar" class="btn btn-primary">Regresar</button></a>
