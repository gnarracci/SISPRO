...
include("include/mainFunctionPro.inc.php");
...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<meta charset="utf-8"/>
			<title>Configuración de Preguntas de Perfil Profesional</title>
			<link rel="shortcut icon" href="favicon.ico"/>
            <link rel="stylesheet" href="cuestionario_set_profesional.css"/>
			...
			<script src="js/modalwindows/mainFormProfesional.js"></script>
		...
		<body>
			...
			<a href="loadsurvey.php"><img src="imagenes/regresar-cues-3.png" height="68px" width="175px" id="float" title="Regresar"/></a>
			...
			<span id="rapport">Preguntas de Perfil Profesional</span>

			<div id="is-3"></div>

			<div id="is-4"></div>

			<!-- Formulario de Carga de Preguntas de Perfil Profesional -->

			<div class="hide" id="agregarPerfil" title="Agregar Pregunta de Perfil Profesional">
				...
				<form action="" method="post" id="formProfesional" name="formProfesional">
					...
					<fieldset id="ocultos">
						...
						<input type="hidden" id="id_profesional" name="id_profesional" class="{required:true}" />
					...
					<fieldset id="datosProfesionales">
					    ...
					    <p>Pregunta de Perfil Profesional</p>
					    <span></span>
					    <input type="text" tabindex="2" id="pregunta_profesional" name="pregunta_profesional" placeholder="Ingrese Pregunta" class="{required:true} span3"/>

					    <p>Tipo Respuesta</p>
					    <span></span>
					    <select tabindex="3" id="respuesta_profesional" name="respuesta_profesional" class="{required:true} span3">
					    ...
					    <fieldset id="botonera" style="text-align:center;">
					    	...
					    	<input type="submit" id="agregar" class="btn btn-success" value="Agregar Pregunta"/>
			...
			<a href="respuestas_profesional.php"><button id="answers" class="a_demo_one" type="submit">Configurar Respuestas</button></a>
							...
							<table id="listQuestions" class="table table-striped table-bordered table-hover table-condensed">
								...
								<thead>
									<tr>
										...
										<th>Pregunta de Perfil Profesional</th>
