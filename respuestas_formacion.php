...
include('include/mainListFormacion.php');
...
include('include/mainFuncRespForm.inc.php');
...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<meta charset="utf-8"/>
			<title>Configuración de Respuestas de Formación</title>
			<link rel="shortcut icon" href="favicon.ico"/>
            <link rel="stylesheet" href="respuestas_formacion.css"/>
			...
			<script src="js/modalwindows/main-view-formacion.js"></script>
		...
		<body>			
			...
			<header>
				...
				<a href="cuestionario_set_formacion.php"><img src="imagenes/returnformacion.png" width="129px" height="43px" id="float" alt="regresar" title="Regresar"/></a>
			...
			<span id="marq">Carga de Respuestas de Formación</span>

			<!-- Ventana para visualizar las Preguntas -->

			<div id="lista-anim" title="Preguntas de Formación cargadas en el Sistema">

				<table id="listarapport" class="table table-striped table-bordered table-hover table-condensed">
					<thead>
						<tr>
							<th>Id</th>
							<th>Pregunta de Formación</th>
			...
			<span id="questions">Respuestas de Formación</span>

			<div id="is-3"></div>

			<div id="agregarRespuesta" class="hide" title="Agregar Respuesta de Formación">
				...
				<form action="" method="post" id="formResp" name="formResp">
					...
					<fieldset id="ocultos">
						...
						<input type="hidden" id="id_resp_formacion" name="id_resp_formacion" class="{required:true}" />

					</fieldset>

					<fieldset id="respuesta" style="text-align:center;">

						<p>Respuesta Pregunta de Formación</p>
						<span></span>
						<input type="text" tabindex="1" id="resp_formacion" name="resp_formacion" placeholder="Ingrese Respuesta" class="{required:true} span3"/>

						<p>Id. Pregunta de Formación a asociar</p>
						<span></span>
					...
					<fieldset id="botonera" style="text-align:center;">
						...
						<input type="submit" id="agregar" class="btn btn-warning" value="Ingrese Respuesta"/>
