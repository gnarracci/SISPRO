...
include("conexionsspi.php");
    ...
    $query = "SELECT * FROM corresponde_formacion";
        ...
        while ($rel = mysql_fetch_array($consult))
        {
            $listarelacion .= '
                <tr>
                    ...
                    <td style="text-align:center;">'.$rel['id_formacion'].'</td>
                    <td style="font-weight:bold;text-align:center;">'.$rel['id_resp_formacion'].'</td>
                </tr>
            ';
        }    
    }
