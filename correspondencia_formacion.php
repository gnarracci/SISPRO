...
include("listar_rel_formacion.php");
...
include('include/mainListAnswersFormacion.php');
...
<html lang="es">
	<head>
		<meta charset="utf-8"/>
		<title>Tabla de Correspondecia Preguntas/Respuestas de Formación</title>
		<link rel="shortcut icon" href="favicon.ico"/>
		<link rel="stylesheet" href="correspondencia_formacion.css"/>
	...
	<body>
		...
		<header>
			...
			<a href="corresponde.php"><img src="imagenes/ritorno-1.png" width="169px" height="89px" id="float" alt="regresar" title="Regresar"/></a>

			<a href="correspondencia_condicion.php"><img src="imagenes/ircondicion.png" width="169px" height="89px" id="ir" alt="ir a formación" title="Ir a Correspondencias de Condición" /></a>

			<img src="imagenes/correspondencia.png" width="960px" height="200px" alt="correspondenciahd" id="correspondenciahd" />

		</header>

		<span id="titulo">Correspondecia Preguntas y Respuestas de Formación</span>
		...
		<a href="#"><img src="imagenes/documentation-1.png" width="42px" height="42px" id="doc" /></a>
		...
		<div id="listaresp" title="Lista de Respuestas de Formación">

			<table id="listarapport" class="table table-striped table-bordered table-hover table-condensed">
				<thead>
					<tr>
						<th>Id</th>
						<th>Respuesta Formación</th>
						<th>Id. Asociado</th>
						<th>Min.(%)</th>
					</tr>
				</thead>
		...
		<!-- Visualizar Relaciones de Preguntas y Respuestas -->
            ...
            <div id="corresponde-anim" title="Relación de Preguntas y Respuestas de Formación">
		...
		<form action="corresponde_formacion.php" id="corres_formacion" name="corres_formacion" method="post">
