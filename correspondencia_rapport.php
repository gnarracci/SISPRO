...
include("listar_rel_rapport.php");

//Incluye archivo de Lista de Preguntas
include('include/mainListRapport.php');
...
include('include/mainListAnswersRapport.php');
...
<html lang="es">
	<head>
		<meta charset="utf-8"/>
		<title>Tabla de Correspondecia Preguntas/Respuestas Rapport</title>
		<link rel="shortcut icon" href="favicon.ico"/>
		<link rel="stylesheet" href="correspondencia_rapport.css"/>
	...
	<body>
		...
		<header>
			...
			<a href="corresponde.php"><img src="imagenes/ritorno.png" width="169px" height="89px" id="float" alt="regresar" title="Regresar"/></a>

			<a href="correspondencia_formacion.php"><img src="imagenes/irformacion.png" width="169px" height="89px" id="ir" alt="ir a formación" title="Ir a Correspondencias de Formación" /></a>

			<img src="imagenes/correspondencia.png" width="960px" height="200px" alt="correspondenciahd" id="correspondenciahd" />

		</header>

		<span id="titulo">Correspondecia Preguntas y Respuestas de Rapport</span>
		...
		<a href="#"><img src="imagenes/documentation.png" width="42px" height="42px" id="doc" /></a>
		...
		<div id="listaresp" title="Lista de Respuestas de Rapport">

			<table id="listarapport" class="table table-striped table-bordered table-hover table-condensed">
				<thead>
					<tr>
						<th>Id</th>
						<th>Respuesta Rapport</th>
						<th>Id. Asociado</th>
						<th>Min.(%)</th>
					</tr>
				</thead>
		...
		<!-- Visualizar Relaciones de Preguntas y Respuestas -->
            ...
            <div id="corresponde-anim" title="Relación de Preguntas y Respuestas de Rapport">
		...
		<form action="corresponde_rapport.php" id="corres_rapport" name="corres_rapport" method="post">
