...
<meta name="keywords" content="jquery, form, sliding, usability, css3, validation, javascript, coal, transportation"/>
<title>INTRANET TRANS COAL DE VENEZUELA</title>
<link rel="shortcut icon" href="favicon.ico"/>
<link rel="stylesheet" type="text/css" media="screen" href="micuenta.css"/>
...
<body>
	...
	<div id="contenedor">
		...
		<div id="galeria">
			...
			<a href="selection.php"><img src="imagenes/regemp.png" width="133px" height="53px" alt="regemp" id="reg" /></a>
		...
		<h2>BIENVENIDO AL SISTEMA</h2>
			...
			<div id="main">
				...
				<ul id="menu">
					...
					<li><a href="#">Reclutamiento y Selección</a>
					
							<ul>
							
								<li><a href="recruit.php">Selección de Personal</a></li>
								<li><a href="curricula.php">Resúmenes Curriculares</a></li>
								<li><a href="identificacion.php">Identificación del Personal</a></li>
							
							</ul>
					
					</li>
					
					<li><a href="#">Auxiliares de Nómina</a>
					
							<ul>
							
								<li><a href="parafiscal.php">Parafiscales</a></li>
								<li><a href="gananciales.php">Gananciales</a></li>
								<li><a href="provisiones.php">Provisiones</a></li>
								<li><a href="cajaahor.php">Caja de Ahorros</a></li>
								<li><a href="faov.php">Faov</a></li>
								<li><a href="fondmed.php">Fondo de Medicinas Obreros</a></li>
								<li><a href="sindicato.php">Sindicato Obreros</a></li>								
							
							</ul>
					
					</li>
					
					<li><a href="#">Otras Nóminas</a>
					
							<ul>
							
								<li><a href="#">Pagares</a></li>
								<li><a href="#">Anticipos</a></li>
								<li><a href="#">Cuadros de Prestaciones</a></li>
								<li><a href="#">Cesta Ticket</a></li>
								<li><a href="#">Utilidades</a></li>
								<li><a href="#">Utilidades Líquidas</a></li>
