...
//Funcion para extraer el listado de Preguntas
    function consultaRespuestas($linkDB){
        ...
        $consulta = $linkDB -> query("SELECT id_resp_rapport,resp_rapport,id_asociado,pctaje_minimo FROM resp_rapport ORDER BY id_resp_rapport ASC"); 
            ...
            while($listadoOK = $consulta -> fetch_assoc())
            {
                $salida .= '
                    <tr>
                        ...
                        <td id="edit" class="centerTXT"><a class="btn btn-small" href="'.$listadoOK['id_resp_rapport'].'">Editar</a></td>
                    </tr>
                ';   
            }
        }
