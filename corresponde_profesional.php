...
include("conexionsspi.php");
    ...
    $sql = "INSERT INTO corresponde_profesional (sipi,id_profesional,id_resp_profesional) VALUES ('$sipi_1','$sipi_2','$sipi_3')";
...
<!DOCTYPE html>
	<html lang="es">
		...
		<body>
            ...
            <a href="correspondencia_profesional.php"><button id="regresar" class="btn btn-primary">Regresar</button></a>
