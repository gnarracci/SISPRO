...
include("listar_rel_condicion.php");
...
include('include/mainListAnswersCondicion.php');
...
<html lang="es">
	<head>
		<meta charset="utf-8"/>
		<title>Tabla de Correspondecia Preguntas/Respuestas de Condiciones</title>
		<link rel="shortcut icon" href="favicon.ico"/>
		<link rel="stylesheet" href="correspondencia_condicion.css"/>
	...
	<body>
		...
		<header>
			...
			<a href="corresponde.php"><img src="imagenes/ritorno-2.png" width="169px" height="89px" id="float" alt="regresar" title="Regresar"/></a>

			<a href="correspondencia_profesional.php"><img src="imagenes/irprofesional.png" width="169px" height="89px" id="ir" alt="ir a formación" title="Ir a Correspondencias de Perfil Profesional" /></a>

			<img src="imagenes/correspondencia.png" width="960px" height="200px" alt="correspondenciahd" id="correspondenciahd" />

		</header>

		<span id="titulo">Correspondecia Preguntas y Respuestas de Condiciones</span>
		...
		<a href="#"><img src="imagenes/documentation-2.png" width="42px" height="42px" id="doc" /></a>
		...
		<div id="lista-anim" title="Lista de Preguntas de Condición">
		...
		<div id="listaresp" title="Lista de Respuestas de Condición">
		...
		<!-- Visualizar Relaciones de Preguntas y Respuestas -->
            ...
            <div id="corresponde-anim" title="Relación de Preguntas y Respuestas de Condición">
		...
		<form action="corresponde_condicion.php" id="corres_condicion" name="corres_condicion" method="post">
