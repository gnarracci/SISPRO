...
<link rel="stylesheet" type="text/css" media="screen" href="paramarinos.css"/>
...
<body>
	...
	<div id="contenedor">
		...
		<div id="galeria">
			...
			<a href="reporteparafismar.php"><img src="imagenes/print.png" width="111px" height="33px" alt="Imprimir" title="Imprimir Reporte" class="print" /></a>
			
		</div> <!-- Fin del Contenedor de la Galeria de Imagenes --> 
 
		<div id="cuerpo">
								
			<span id="paraobrero">PROVISION PARAFISCAL MES DE <?Php echo mes()." ".date("Y");?> MARINOS TCV</span>
				...
				<form id="parafisobrero" name="form1" method="post" action="">
					...
					<ul class="paging"><?Php 
						...
						if ($pag>1)
							echo "<a href='paramarinos.php?pag=". ($pag-1) ."' >Anterior</a> ";
								for ($cont = 1;$cont<=$paginas;$cont++){
								
									if ($cont==$pag)
										echo $cont. " ";
										else
										echo "<a href='paramarinos.php?pag=". $cont ."' >$cont</a> ";
								
								}
						if ($pag<$paginas)
							echo "<a href='paramarinos.php?pag=". ($pag+1) ."' >Siguiente</a> ";
					?></ul>
