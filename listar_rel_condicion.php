...
include("conexionsspi.php");
    ...
    $query = "SELECT * FROM corresponde_condicion";
        ...
        while ($rel = mysql_fetch_array($consult))
        {
            $listarelacion .= '
                <tr>
                    ...
                    <td style="text-align:center;">'.$rel['id_condicion'].'</td>
                    <td style="font-weight:bold;text-align:center;">'.$rel['id_resp_condicion'].'</td>
                </tr>
            ';
        }    
    }
