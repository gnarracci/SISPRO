...
include("conexionsspi.php");
    ...
    $sql = "INSERT INTO corresponde_condicion (sipi,id_condicion,id_resp_condicion) VALUES ('$sipi_1','$sipi_2','$sipi_3')";
...
<!DOCTYPE html>
	<html lang="es">
		...
		<body>
            ...
            <a href="correspondencia_condicion.php"><button id="regresar" class="btn btn-primary">Regresar</button></a>
				...
				<div id="footercontainer">
					...
					<div id="footercon">
						...
						<ul id="links">
							...
							<p class="copyright">Derechos Reservados © <?Php echo date("Y"); ?> Trans Coal de Venezuela,C.A. - San Francisco - Venezuela <span>|</span> <span> Diseno y Código:Departamento de Sistemas TCV</span></p>
