...
include('include/mainFuncRespRapp.inc.php');
...
<!DOCTYPE html>
	<html lang="es">
		<head>
            ...
            <link rel="stylesheet" href="respuestas_rapport.css"/>
			...
			<script src="js/modalwindows/main-view-answers.js"></script>
		...
		<body>			
			...
			<header>
				...
				<a href="cuestionario_set_rapport.php"><img src="imagenes/returnrapport.png" width="129px" height="43px" id="float" alt="regresar" title="Regresar"/></a>
			...
			<span id="marq">Carga de Respuestas de Rapport</span>

			<!-- Ventana para visualizar las Preguntas -->

			<div id="lista-anim" title="Preguntas de Rapport cargadas en el Sistema">
			...
			<span id="questions">Respuestas de Rapport</span>

			<div id="is-3"></div>

			<div id="agregarRespuesta" class="hide" title="Agregar Respuesta de Rapport">
				...
				<form action="" method="post" id="formResp" name="formResp">
					...
					<fieldset id="ocultos">
						...
						<input type="hidden" id="id_resp_rapport" name="id_resp_rapport" class="{required:true}" />

					</fieldset>

					<fieldset id="respuesta" style="text-align:center;">

						<p>Respuesta Pregunta de Rapport</p>
						<span></span>
						<input type="text" tabindex="1" id="resp_rapport" name="resp_rapport" placeholder="Ingrese Respuesta" class="{required:true} span3"/>

						<p>Id. Pregunta Rapport a asociar</p>
						<span></span>
					...
					<fieldset id="botonera" style="text-align:center;">
						...
						<input type="submit" id="agregar" class="btn btn-primary" value="Ingrese Respuesta"/>
