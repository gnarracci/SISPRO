...
include("conexionsspi.php");
    ...
    if (isset($_POST['sele_puesto'])){
        $puesto = $_POST['sele_puesto'];
        $per_rapport = $_POST['rapport-req'];
        $per_formacion = $_POST['formacion-req'];
        $per_condiciones = $_POST['condiciones-req'];
        $per_profesional = $_POST['perfil-req'];
        
    //Si las variables fueron enviadas se procede a la insercion de los datos
    
    $sql = "INSERT INTO requerimientos_encuesta (puesto_trabajo,rapport,formacion,condiciones,profesional) VALUES ('$puesto','$per_rapport','$per_formacion','$per_condiciones','$per_profesional')";
...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<meta charset="utf-8"/>
			<title>Mensaje del Sistema Perfiles de Empleo</title>
				...
				<div id="footercontainer">
					...
					<div id="footercon">
						...
						<ul id="links">
							...
							<p class="copyright">Derechos Reservados - <?Php echo date("Y"); ?> Trans Coal de Venezuela,C.A. - San Francisco - Venezuela <span>|</span> <span> Diseno y Codigo:Departamento de Sistemas TCV</span></p>
