...
//Configurar la cantidad de registros a ser mostrados por paginacion
$hasta = 14;
...
<link rel="stylesheet" type="text/css" media="screen" href="paraempleados.css"/>
...
<body>
	...
	<div id="contenedor">
		...
		<div id="galeria">
			...
			<a href="reporteparafisemp.php"><img src="imagenes/print.png" width="111px" height="33px" alt="Imprimir" title="Imprimir Reporte" class="print" /></a>
			
		</div> <!-- Fin del Contenedor de la Galeria de Imagenes --> 
 
		<div id="cuerpo">
								
			<span id="paraobrero">PROVISION PARAFISCAL MES DE <?Php echo mes()." ".date("Y");?> EMPLEADOS TCV</span>
				...
				<form id="parafisobrero" name="form1" method="post" action="">
					...
					<table width="850" border="0">
						  ...
						  <tr class="cabtab">
							...
							// Estableciendo Tope de Salario para el Calculo Parafiscal
								...
								$salario = $row["SALARIO"]; // Salario Mensual del Empleado
					...
					<ul class="paging"><?Php 
						...
						if ($pag>1)
							echo "<a href='paraempleados.php?pag=". ($pag-1) ."' >Anterior</a> ";
								for ($cont = 1;$cont<=$paginas;$cont++){
								
									if ($cont==$pag)
										echo $cont. " ";
										else
										echo "<a href='paraempleados.php?pag=". $cont ."' >$cont</a> ";
								
								}
						if ($pag<$paginas)
							echo "<a href='paraempleados.php?pag=". ($pag+1) ."' >Siguiente</a> ";
					?></ul>
