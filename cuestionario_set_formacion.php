...
include("include/mainFunctionFor.inc.php");
...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<meta charset="utf-8"/>
			<title>Configuración de Preguntas de Formación</title>
			<link rel="shortcut icon" href="favicon.ico"/>
            <link rel="stylesheet" href="cuestionario_set_formacion.css"/>
			...
			<script src="js/modalwindows/mainFormFormacion.js"></script>
		...
		<body>
			...
			<a href="loadsurvey.php"><img src="imagenes/regresar-cues-1.png" height="68px" width="175px" id="float" title="Regresar"/></a>
			...
			<span id="rapport">Preguntas de Formación</span>

			<div id="is-3"></div>

			<div id="is-4"></div>

			<!-- Formulario de Carga de Preguntas de Formacion -->

			<div class="hide" id="agregarPerfil" title="Agregar Pregunta de Formación">
				...
				<form action="" method="post" id="formProfesional" name="formProfesional">
					...
					<fieldset id="ocultos">
						...
						<input type="hidden" id="id_formacion" name="id_formacion" class="{required:true}" />
					...
					<fieldset id="datosProfesionales">
					    ...
					    <p>Pregunta de Formación</p>
					    <span></span>
					    <input type="text" tabindex="2" id="pregunta_formacion" name="pregunta_formacion" placeholder="Ingrese Pregunta" class="{required:true} span3"/>

					    <p>Tipo Respuesta</p>
					    <span></span>
					    <select tabindex="3" id="respuesta_formacion" name="respuesta_formacion" class="{required:true} span3">
					    ...
					    <fieldset id="botonera" style="text-align:center;">
					    	...
					    	<input type="submit" id="agregar" class="btn btn-warning" value="Agregar Pregunta"/>
			...
			<a href="respuestas_formacion.php"><button id="answers" class="a_demo_one" type="submit">Configurar Respuestas</button></a>
