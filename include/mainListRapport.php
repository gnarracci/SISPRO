...
//Funcion para extraer el listado de Preguntas
    function consultaPreguntas($linkDB){
        ...
        $consulta = $linkDB -> query("SELECT id_rapport,puesto_trabajo,pregunta_rapport,respuesta_rapport,pregunta_pctaje FROM cuestionario_rapport ORDER BY id_rapport ASC"); 
        ...
        if($consulta -> num_rows != 0){
            ...
            while($listadoOK = $consulta -> fetch_assoc())
            {
                $salida .= '
                    <tr>
                        <td style="color: red;font-weight: bold;text-align:center;">'.$listadoOK['id_rapport'].'</td>
